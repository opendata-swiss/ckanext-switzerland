...
def get_piwik_config():
    return {
        ...
        'custom_dimension_visit_dataset_id': tk.config.get('piwik.custom_dimension_visit_dataset_id', False),
        'custom_dimension_action_dataset_id': tk.config.get('piwik.custom_dimension_action_dataset_id', False),
        'custom_dimension_action_format_id': tk.config.get('piwik.custom_dimension_action_format_id', False)
    }
